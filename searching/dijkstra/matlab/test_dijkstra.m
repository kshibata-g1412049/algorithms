% test_dijkstra.m
%
% dijkstra関数のテストスクリプト（MATLAB/Octave両対応）。
...
startPos = [1 1];
goalPos = [5 5];
path1 = dijkstra(grid1, startPos, goalPos);
...
startPos = [1 1];
goalPos = [5 5];
path2 = dijkstra(grid2, startPos, goalPos);
